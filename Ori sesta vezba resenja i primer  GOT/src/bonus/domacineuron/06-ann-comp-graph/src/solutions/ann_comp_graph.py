...
if __name__ == '__main__':
    ...
    #print(ulaz.values.tolist())
    izlaz = pd.read_csv (r'C:\Users\Admin\Desktop\ori-2021-e2-public-main\06-ann-comp-graph\data\occupancy_train.csv',usecols=[7])
    #print(izlaz.values.tolist())
    test_ulaz = pd.read_csv (r'C:\Users\Admin\Desktop\ori-2021-e2-public-main\06-ann-comp-graph\data\occupancy_test.csv',usecols=[1,2,3,4,5])
    test_izlaz = pd.read_csv (r'C:\Users\Admin\Desktop\ori-2021-e2-public-main\06-ann-comp-graph\data\occupancy_test.csv',usecols=[6])
    ...
    history = mm.fit(ulaz.values.tolist(), izlaz.values.tolist(), learning_rate=0.1,  momentum=0.3, nb_epochs=10000, shuffle=True, verbose=0)
    # provera da li radi
    #for i in range(test_ulaz.values.tolist()) :
    #    print(mm.predict(test_ulaz.values.tolist()[i])-test_izlaz.values.tolist()[i])
